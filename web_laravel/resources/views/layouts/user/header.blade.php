        ...
        <div class="col-sm-6">
          <div class="contactinfo">
            <ul class="nav nav-pills">
              <li><a href="#"><i class="fa fa-phone"></i> 0705001189</a></li>
              <li><a href="#"><i class="fa fa-phone"></i> 0912599455</a></li>
              <li><a href="#"><i class="fa fa-envelope"></i> nxuanhuy992004@gmail.com</a></li>
            </ul>
          </div>
        </div>
      </div>
